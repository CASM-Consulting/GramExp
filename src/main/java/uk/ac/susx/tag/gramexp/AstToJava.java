...
public class AstToJava implements Visitor {
    ...
    public void visit(GrammarNode node) {
        ...
        printer.println();
        printer.print("import uk.ac.susx.tag.gramexp.CapturingParser;");
        printer.println();
        printer.print("import uk.ac.susx.tag.gramexp.Capture;");
        printer.println();
    ...
    public void visit(PrefixNode node) {
        ...
        if(capture != null) {
            ...
            printer.print(",push(Capture.of("+ref+", match())))");
            groups.add(ref);
        }
        if(optional != null) {
            printer.print(")");
